...
const SearchModal = () => {
   ...
   return (
      <>
         <div>
            <button
               className="flex items-center space-x-3 px-1 text-lg text-slate-800 dark:text-slate-300 xl:text-sm xl:text-slate-400 rtl:space-x-reverse"
               onClick={openModal}
            >
               <>
                        ...
                        <div className="relative">
                           <div className="ring-gray-500-500 dark:ring-light divide-gray-500-300 dark:divide-light relative mx-auto max-w-xl divide-y rounded-md bg-white shadow-2xl ring-1 dark:bg-slate-800">
                              <div className="flex items-center rounded-md  bg-white px-3 py-3 dark:bg-slate-800">
                                 <div className="flex-0  text-lg text-slate-700 dark:text-slate-300 ltr:pr-2 rtl:pl-2">
                                    <Icon icon="heroicons-outline:search" />
                                 </div>
                                 <Combobox.Input
