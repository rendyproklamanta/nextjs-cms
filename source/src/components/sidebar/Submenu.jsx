                  ...
                  {subItem?.multi_menu ? (
                     ...
                     <Link href={'/' + subItem.childlink}>
                        ...
                        >
                           ...
                           ></span>
                           <span className={`flex-1 ${locationName === subItem.childlink && 'text-black-900 dark:text-white'}`}>{subItem.childtitle}</span>
                        </span>
                     </Link>
                  )}
               </li>
